...
<svg width="500" height="200">
{% for number in numbers %}
    <rect y="{{loop.index * 20}}" width={{number}} height="17" style="fill:rgb(0,0,255);stroke-width:3;stroke:rgb(0,0,0)" />
{% endfor %}
</svg>
...
{% for point in data %}
    <circle cx="{{point[0]*3+150}}" cy="{{point[1]*3}}" r="2" stroke="black" stroke-width="3" fill="red" />
{% endfor %}
</svg>
...
<svg width="500" height="200" style="border:1px solid grey">
{% for point in data %}
    <circle cx="{{point[0]*3+150}}" cy="{{point[1]*3}}" r="{{point[2]*3}}" stroke="black" stroke-width="3" fill="red" />
{% endfor %}
</svg>
